...
The last entry in the previous log is an `addressbook::notify` action sent to `alice`. Use [alacli get actions]() to display actions executed and relevant to alice.
