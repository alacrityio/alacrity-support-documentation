...
A set of ALAIO keys is required to create an account. The ALAIO keys can be generated by using alacli create key.

    alacli create account inita tester ALA4toFS3YXEQCkuuw1aqDLrtHim86Gz9u3hBdcBw5KNPZcursVHq ALA7d9A3uLe6As66jzN8j44TXJUqJSK3bFjjEEqR4oTvNAB3iM9SA
